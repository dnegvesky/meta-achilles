...
SRC_URI_achilles = "git://github.com/altera-opensource/u-boot-socfpga.git;branch=socfpga_v2014.10_arria10_bringup;prot=https"

SRCREV_FORMAT = "achilles"
#SRCREV_achilles = "${AUTOREV}"

SRC_URI_append = "\
	file://0001-rxc-achilles-uboot.patch \
	"
